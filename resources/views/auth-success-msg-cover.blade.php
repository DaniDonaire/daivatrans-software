                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center">
                                <p class="mb-0">&copy; <script>document.write(new Date().getFullYear())</script> {{ config('settings.app_name') ?? 'Web Coding' }}. Crafted with <i class="mdi mdi-heart text-danger"></i> by Web Coding</p>
                            </div>
                        </div>
                    </div>
                </div>
