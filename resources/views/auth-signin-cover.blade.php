                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Sign in to continue to {{ config('settings.app_name') ?? 'Web Coding' }}.</p>
                                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            </script> {{ config('settings.app_name') ?? 'Web Coding' }}. Crafted with <i
                                    class="mdi mdi-heart text-danger"></i> by Web Coding</p>
                        </div>
                    </div>
                </div>
            </div>
