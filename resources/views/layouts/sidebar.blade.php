        ...
        <a href="{{ route('root') }}" class="logo logo-dark">
            ...
            <span class="logo-lg">
                @if($logo)
                    ...
                    <img src="{{ config('settings.logo_rectangular') ? asset('storage/' . config('settings.logo_rectangular')) : asset('build/images/WCD_White.png') }}" height="40">
                @else
                    <!-- Mostrar logo predeterminado -->
                ...
                @can('roles_list')
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ route('roles.index') }}">
                            <i class="ri-user-settings-line"></i><span>@lang('translation.manage-roles')</span>
                        </a>
                    </li>
                @endcan
                @can('audit_list')
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ route('audit.index') }}">
                            <i class="ri-eye-fill"></i><span>@lang('translation.audit')</span>
                        </a>
                    </li>
                @endcan
                @can('config_list')
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ route('settings.index') }}">
                            <i class="ri-settings-line"></i> <span>@lang('translation.configuration')</span>
                        </a>
                    </li>
                @endcan
