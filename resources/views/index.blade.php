                ...
                <div class="col-12">
                    <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                        <div class="flex-grow-1">
                            <h4 class="fs-16 mb-1">@lang('home.greeting'){{ Auth::user()->name }}!</h4>
                            <p class="text-muted mb-0">@lang('home.store_update')</p>
                        </div>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if(isset($leadsPorServicio) && $leadsPorServicio && $leadsPorServicio->count() > 0)
                                <div class="table-responsive table-card">
                                    <table class="table table-borderless table-hover table-nowrap align-middle mb-0">
                                        ...
                                        <tbody>
                                            @foreach($leadsPorServicio as $servicio)
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-xs bg-{{ $loop->index % 5 == 0 ? 'primary' : ($loop->index % 5 == 1 ? 'success' : ($loop->index % 5 == 2 ? 'warning' : ($loop->index % 5 == 3 ? 'info' : 'danger'))) }}-subtle rounded-circle me-2">
                                                        </div>
                                                        <div>
                                                            <h6 class="fs-14 mb-0">{{ $servicio->servicio_nombre }}</h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <h6 class="mb-0">{{ $servicio->total_leads }}</h6>
                                                </td>
                                                <td>
                                                    <span class="badge bg-{{ $loop->index % 5 == 0 ? 'primary' : ($loop->index % 5 == 1 ? 'success' : ($loop->index % 5 == 2 ? 'warning' : ($loop->index % 5 == 3 ? 'info' : 'danger'))) }}-subtle text-{{ $loop->index % 5 == 0 ? 'primary' : ($loop->index % 5 == 1 ? 'success' : ($loop->index % 5 == 2 ? 'warning' : ($loop->index % 5 == 3 ? 'info' : 'danger'))) }}">
                                                        {{ $servicio->porcentaje }}%
                                                    </span>
                                                </td>
                                            </tr>
                                ...
                                <div class="align-items-center mt-4 pt-3 justify-content-between row text-center text-sm-start border-top">
                                    <div class="col-sm">
                                        <div class="text-muted">
                                            Total de <span class="fw-semibold text-success">{{ $totalLeads ?? 0 }}</span> leads distribuidos en 
                                            <span class="fw-semibold">{{ $leadsPorServicio->count() }}</span> servicios
                                        </div>
                                    </div>
                                </div>
                            @else
