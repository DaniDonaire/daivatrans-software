        ...
        <div class="h-100">
                ...
                <div class="col-12">
                    <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                        <div class="flex-grow-1">
                            <h4 class="fs-16 mb-1"><?php echo app('translator')->get('home.greeting'); ?><?php echo e(Auth::user()->name); ?>!</h4>
                            <p class="text-muted mb-0"><?php echo app('translator')->get('home.store_update'); ?></p>
                        </div>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Leads por Servicio</h4>
                        </div>

                        <div class="card-body">
                            <?php if(isset($leadsPorServicio) && $leadsPorServicio && $leadsPorServicio->count() > 0): ?>
                                <div class="table-responsive table-card">
                                    <table class="table table-borderless table-hover table-nowrap align-middle mb-0">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $leadsPorServicio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servicio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-xs bg-<?php echo e($loop->index % 5 == 0 ? 'primary' : ($loop->index % 5 == 1 ? 'success' : ($loop->index % 5 == 2 ? 'warning' : ($loop->index % 5 == 3 ? 'info' : 'danger')))); ?>-subtle rounded-circle me-2">
                                                        </div>
                                                        <div>
                                                            <h6 class="fs-14 mb-0"><?php echo e($servicio->servicio_nombre); ?></h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <h6 class="mb-0"><?php echo e($servicio->total_leads); ?></h6>
                                                </td>
                                                <td>
                                                    <span class="badge bg-<?php echo e($loop->index % 5 == 0 ? 'primary' : ($loop->index % 5 == 1 ? 'success' : ($loop->index % 5 == 2 ? 'warning' : ($loop->index % 5 == 3 ? 'info' : 'danger')))); ?>-subtle text-<?php echo e($loop->index % 5 == 0 ? 'primary' : ($loop->index % 5 == 1 ? 'success' : ($loop->index % 5 == 2 ? 'warning' : ($loop->index % 5 == 3 ? 'info' : 'danger')))); ?>">
                                                        <?php echo e($servicio->porcentaje); ?>%
                                                    </span>
                                                </td>
                                            </tr>
                                ...
                                <!-- Resumen inferior -->
                                <div class="align-items-center mt-4 pt-3 justify-content-between row text-center text-sm-start border-top">
                                    <div class="col-sm">
                                        <div class="text-muted">
                                            Total de <span class="fw-semibold text-success"><?php echo e($totalLeads ?? 0); ?></span> leads distribuidos en 
                                            <span class="fw-semibold"><?php echo e($leadsPorServicio->count()); ?></span> servicios
                                        </div>
                                    </div>
                                </div>
                            <?php else: ?>
                                ...
                                <div class="text-center py-5">
                                    <div class="avatar-md mx-auto mb-4">
                                        <div class="avatar-title bg-light text-muted rounded-circle fs-4">
                                            <i class="ri-database-2-line"></i>
                                        </div>
                                    </div>
                                    <h5 class="mb-1">No hay leads registrados</h5>
                                    <p class="text-muted mb-3">Comienza creando tu primer lead para ver las estadísticas por servicio</p>
                                    <a href="<?php echo e(route('leads.create')); ?>" class="btn btn-primary">
                                        <i class="ri-add-circle-line me-1"></i>Crear Primer Lead
                                    </a>
                                </div>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\daivatrans-software\resources\views/index.blade.php ENDPATH**/ ?>