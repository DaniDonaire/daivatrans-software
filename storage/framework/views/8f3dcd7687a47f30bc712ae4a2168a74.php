...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('workers.create_title'); ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('workers.store')); ?>" method="POST" class="row g-3">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Teléfono -->
                        <div class="col-md-4">
                            <label for="phone" class="form-label"><?php echo app('translator')->get('workers.phone_label'); ?></label>
                            <input type="text" 
