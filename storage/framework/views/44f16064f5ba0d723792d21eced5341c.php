...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" data-topbar="light">
    ...
    <head>
    <meta charset="utf-8" />
    <title><?php echo $__env->yieldContent('title'); ?> | <?php echo e(config('settings.app_name') ?? 'Web Coding'); ?></title>
...
<?php /**PATH C:\laragon\www\daivatrans-software\resources\views/layouts/master-without-nav.blade.php ENDPATH**/ ?>