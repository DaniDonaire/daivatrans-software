...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="<?php echo e(route('root')); ?>" class="logo logo-dark">
            <span class="logo-sm">
                <?php
                    $logo = App\Models\Settings::first(); // Consulta para verificar si hay registros
                ?>
                <?php if($logo): ?>
            ...
            <span class="logo-lg">
                <?php if($logo): ?>
                    <!-- Mostrar logo rectangular si existe -->
                    <img src="<?php echo e(config('settings.logo_rectangular') ? asset('storage/' . config('settings.logo_rectangular')) : asset('build/images/WCD_White.png')); ?>" height="40">
                <?php else: ?>
                    <!-- Mostrar logo predeterminado -->
                    <h1 class="m-0" style="font-size: 24px; color: #fff;">Titulo</h1>
                <?php endif; ?>
            </span>
        </a>
        <!-- Light Logo -->
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles_list')): ?>
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="<?php echo e(route('roles.index')); ?>">
                            <i class="ri-user-settings-line"></i><span><?php echo app('translator')->get('translation.manage-roles'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('audit_list')): ?>
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="<?php echo e(route('audit.index')); ?>">
                            <i class="ri-eye-fill"></i><span><?php echo app('translator')->get('translation.audit'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('config_list')): ?>
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="<?php echo e(route('settings.index')); ?>">
                            <i class="ri-settings-line"></i> <span><?php echo app('translator')->get('translation.configuration'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
...
<?php /**PATH C:\laragon\www\daivatrans-software\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>