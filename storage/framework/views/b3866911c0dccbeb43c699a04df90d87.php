...
<?php $__env->startSection('title', 'Estatus '); ?>

<?php $__env->startSection('content'); ?>
<div class="row g-4 mb-4">
    <div class="flex-grow-1">
        <a href="<?php echo e(route('status.create')); ?>" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Crear Estatus</a>        
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <!-- <form method="GET" action="<?php echo e(route('status.index')); ?>">
                    <div class="row g-3">
                            ...
                            <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="text-nowrap">
                                        <a href="<?php echo e(route('status.edit', $stat->id)); ?>" class="btn btn-primary btn-sm">
                                            <i class="ri-edit-line"></i>
                                        </a>

                                        <form action="<?php echo e(route('status.destroy', $stat->id)); ?>" method="POST" style="display:inline-block;">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <td><?php echo e($stat->color); ?></td>
                                    <td><?php echo e($stat->text_color); ?></td>
                                </tr>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PlantillaVelozon\resources\views/status/index.blade.php ENDPATH**/ ?>