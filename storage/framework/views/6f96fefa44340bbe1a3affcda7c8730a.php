<?php if($paginator->hasPages()): ?>
    <nav>
        ...
        <p class="text-muted mt-2">
            Mostrando <?php echo e($paginator->firstItem()); ?> - <?php echo e($paginator->lastItem()); ?> de <?php echo e($paginator->total()); ?> elementos.
        </p>
    </nav>
<?php endif; ?>
<?php /**PATH C:\laragon\www\daivatrans-software\resources\views/vendor/pagination/bootstrap-4.blade.php ENDPATH**/ ?>