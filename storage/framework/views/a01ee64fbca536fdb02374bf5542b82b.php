<header id="page-topbar">
    ...
    <div class="dropdown-menu dropdown-menu-end">
        <!-- English -->
        <a href="<?php echo e(url('index/en')); ?>" class="dropdown-item notify-item language py-2" title="English">
            <img src="<?php echo e(URL::asset('build/images/flags/us.svg')); ?>" alt="user-image" class="me-2 rounded" height="18">
            <span class="align-middle">English</span>
        </a>

        <!-- Spanish -->
        <a href="<?php echo e(url('index/es')); ?>" class="dropdown-item notify-item language" title="Spanish">
            <img src="<?php echo e(URL::asset('build/images/flags/spain.svg')); ?>" alt="user-image" class="me-2 rounded" height="18">
            <span class="align-middle">Español</span>
        </a>

        <!-- German -->
        <a href="<?php echo e(url('index/de')); ?>" class="dropdown-item notify-item language" title="German">
            <img src="<?php echo e(URL::asset('build/images/flags/germany.svg')); ?>" alt="user-image" class="me-2 rounded" height="18"> 
            <span class="align-middle">Deutsch</span>
        </a>

        <!-- Italian -->
        <a href="<?php echo e(url('index/it')); ?>" class="dropdown-item notify-item language" title="Italian">
            <img src="<?php echo e(URL::asset('build/images/flags/italy.svg')); ?>" alt="user-image" class="me-2 rounded" height="18">
            <span class="align-middle">Italiano</span>
        </a>

        <!-- Russian -->
        <a href="<?php echo e(url('index/ru')); ?>" class="dropdown-item notify-item language" title="Russian">
            <img src="<?php echo e(URL::asset('build/images/flags/russia.svg')); ?>" alt="user-image" class="me-2 rounded" height="18">
            <span class="align-middle">Русский</span>
        </a>

        <!-- Chinese -->
        <a href="<?php echo e(url('index/zh')); ?>" class="dropdown-item notify-item language" title="Chinese">
        ...
        <!-- French -->
        <a href="<?php echo e(url('index/fr')); ?>" class="dropdown-item notify-item language" title="French">
            <img src="<?php echo e(URL::asset('build/images/flags/french.svg')); ?>" alt="user-image" class="me-2 rounded" height="18">
            <span class="align-middle">Français</span>
        </a>

        <!-- Arabic -->
        <a href="<?php echo e(url('index/ar')); ?>" class="dropdown-item notify-item language" title="Arabic">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="<?php if(Auth::user()->avatar != ''): ?> <?php echo e(URL::asset('storage/' . Auth::user()->avatar)); ?><?php else: ?><?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?> <?php endif; ?>" alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo e(Auth::user()->name); ?></span>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"><?php echo e(isset(Auth::user()->roles->first()->name) ? Auth::user()->roles->first()->name : ''); ?></span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header"><?php echo e(__('home.welcome_user')); ?><?php echo e(Auth::user()->name); ?>!</h6>
                        <a class="dropdown-item" href="<?php echo e(route('users.edit', Auth::user()->id)); ?>"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle"><?php echo app('translator')->get('translation.profile'); ?></span></a>
...
<?php /**PATH C:\laragon\www\daivatrans-software\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>